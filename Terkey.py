...
if __name__=='__main__':
    ...
    while t.is_alive():
        for i in "-\|/-\|/":
            ...
            sleep(0.1)
    banner()
    print(c+'Silahkan hubungi No whatsapp :"085779617770" jika ada yang mau di bicarakan terkait tool ini, bisnis atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
